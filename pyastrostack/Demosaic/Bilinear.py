...
class Bilinear(Demosaic):
    ...
    def demosaic(self, image):
        ...
        r = np.zeros_like(image.data)
        g = np.zeros_like(image.data)
        b = np.zeros_like(image.data)
        cfa = np.flipud(image.data)
